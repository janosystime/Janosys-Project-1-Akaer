...
async function main() {
  ...
  if (versoesCount === 0) {
    ...
    for (const n of todasNormas) {
      await prisma.versaoNorma.create({
        data: {
          normaId: n.id, numero: 1, evento: 'CADASTRO',
          usuarioNome: n.criadoPor || 'Sistema',
          codigo: n.codigo, titulo: n.titulo, organizacao: n.organizacao,
          categoria: n.categoria, subcategoria: n.subcategoria, item: n.item,
          tipo: n.tipo, revisao: n.revisao, status: n.status,
          notas: n.notas, referencias: n.referencias, palavrasChave: n.palavrasChave,
          nomePdf: n.nomePdf, urlPdf: n.urlPdf, imagens: n.imagens,
        },
      });
    }
  } else {
