  ...
  return (
    <div className="chatbot-container">
      ...
      <div className="chatbot-boas-vindas">
        ...
        <h3>Funcionalidade indisponível nesta versão</h3>
        <p style={{ maxWidth: 480, textAlign: "center", color: "var(--c-text-muted)", lineHeight: 1.7 }}>
          ...
          com modelos de linguagem e base vetorial, que não é compatível com hospedagem estática em nuvem.
        </p>
        <p style={{ maxWidth: 480, textAlign: "center", color: "var(--c-text-muted)", lineHeight: 1.7 }}>
          Esta versão online é uma demonstração das demais funcionalidades do sistema SIGNA.
        ...
        <a
          href="https://github.com/JanoSys-Technologies"
          target="_blank"
