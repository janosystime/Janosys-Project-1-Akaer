...
- 🔐 Expansão de Controle e Segurança
  . Implementação do controle de acesso por níveis de usuário, garantindo permissões mais refinadas e segurança operacional;
  . Estruturação de autenticação mais robusta para diferentes responsabilidades dentro do sistema.

- ⭐ Personalização e Flexibilidade
  . Implementação da funcionalidade de favoritar normas cadastradas para melhorar organização individual e acesso rápido;
...
- 📜 Rastreabilidade e Auditoria
 . Criação do histórico de alterações de normas, registrando modificações, responsáveis e datas;
